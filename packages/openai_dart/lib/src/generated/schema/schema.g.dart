...
Map<String, dynamic> _$CreateCompletionRequestToJson(
  ...
  'prompt': _$JsonConverterToJson<Object?, CompletionPrompt>(
    instance.prompt,
    const _CompletionPromptConverter().toJson,
  ),
  ...
  'seed': ?instance.seed,
  'stop': ?const _CompletionStopConverter().toJson(instance.stop),
...
_CreateCompletionResponse _$CreateCompletionResponseFromJson(
  ...
  object: $enumDecode(_$CreateCompletionResponseObjectEnumMap, json['object']),
...
_CompletionChoice _$CompletionChoiceFromJson(Map<String, dynamic> json) =>
    _CompletionChoice(
      finishReason: $enumDecodeNullable(
        _$CompletionFinishReasonEnumMap,
        json['finish_reason'],
...
_CreateChatCompletionRequest _$CreateChatCompletionRequestFromJson(
  ...
  prediction: json['prediction'] == null
      ? null
      : PredictionContent.fromJson(json['prediction'] as Map<String, dynamic>),
  ...
  tools: (json['tools'] as List<dynamic>?)
      ...
      .toList(),
  toolChoice: const _ChatCompletionToolChoiceOptionConverter().fromJson(
    json['tool_choice'],
  ),
  parallelToolCalls: json['parallel_tool_calls'] as bool?,
  user: json['user'] as String?,
  functionCall: const _ChatCompletionFunctionCallConverter().fromJson(
    json['function_call'],
  ),
...
Map<String, dynamic> _$CreateChatCompletionRequestToJson(
  ...
  'user': ?instance.user,
  'function_call': ?const _ChatCompletionFunctionCallConverter().toJson(
...
_$ChatCompletionToolChoiceOptionChatCompletionNamedToolChoiceFromJson(
  ...
  ChatCompletionNamedToolChoice.fromJson(json['value'] as Map<String, dynamic>),
  $type: json['runtimeType'] as String?,
);

Map<String, dynamic>
_$ChatCompletionToolChoiceOptionChatCompletionNamedToolChoiceToJson(
  ChatCompletionToolChoiceOptionChatCompletionNamedToolChoice instance,
) => <String, dynamic>{
...
_$ChatCompletionFunctionCallEnumerationFromJson(Map<String, dynamic> json) =>
    ChatCompletionFunctionCallEnumeration(
...
Map<String, dynamic>
_$ChatCompletionFunctionCallChatCompletionFunctionCallOptionToJson(
...
_ChatCompletionFunctionCallOption _$ChatCompletionFunctionCallOptionFromJson(
  Map<String, dynamic> json,
) => _ChatCompletionFunctionCallOption(name: json['name'] as String);
...
_ChatCompletionNamedToolChoice _$ChatCompletionNamedToolChoiceFromJson(
  ...
  type: $enumDecode(_$ChatCompletionNamedToolChoiceTypeEnumMap, json['type']),
...
_ChatCompletionMessageToolCall _$ChatCompletionMessageToolCallFromJson(
  ...
  id: json['id'] as String,
  type: $enumDecode(_$ChatCompletionMessageToolCallTypeEnumMap, json['type']),
...
const _$AnnotationTypeEnumMap = {AnnotationType.urlCitation: 'url_citation'};
...
_PredictionContent _$PredictionContentFromJson(Map<String, dynamic> json) =>
    _PredictionContent(
      ...
      content: const _PredictionContentContentConverter().fromJson(
        json['content'],
      ),
    );
...
Map<String, dynamic> _$PredictionContentToJson(_PredictionContent instance) =>
    <String, dynamic>{
      'type': instance.type,
      'content': const _PredictionContentContentConverter().toJson(
        instance.content,
      ),
    };
...
_$PredictionContentContentListChatCompletionMessageContentPartTextFromJson(
  ...
  (json['value'] as List<dynamic>)
      .map(
        (e) => ChatCompletionMessageContentPartText.fromJson(
...
_$PredictionContentContentListChatCompletionMessageContentPartTextToJson(
  PredictionContentContentListChatCompletionMessageContentPartText instance,
) => <String, dynamic>{
...
_ChatCompletionStreamOptions _$ChatCompletionStreamOptionsFromJson(
  Map<String, dynamic> json,
) => _ChatCompletionStreamOptions(includeUsage: json['include_usage'] as bool?);
...
_CreateChatCompletionResponse _$CreateChatCompletionResponseFromJson(
  ...
  choices: (json['choices'] as List<dynamic>)
      .map(
        (e) => ChatCompletionResponseChoice.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  created: (json['created'] as num).toInt(),
  model: json['model'] as String,
...
_ChatCompletionLogprobs _$ChatCompletionLogprobsFromJson(
  ...
  content: (json['content'] as List<dynamic>?)
      ?.map(
        (e) => ChatCompletionTokenLogprob.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
...
_$CreateChatCompletionStreamResponseFromJson(Map<String, dynamic> json) =>
    _CreateChatCompletionStreamResponse(
      ...
      choices: (json['choices'] as List<dynamic>?)
          ?.map(
            (e) => ChatCompletionStreamResponseChoice.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
...
_ChatCompletionStreamResponseDelta _$ChatCompletionStreamResponseDeltaFromJson(
  ...
  toolCalls: (json['tool_calls'] as List<dynamic>?)
      ?.map(
        (e) => ChatCompletionStreamMessageToolCallChunk.fromJson(
          e as Map<String, dynamic>,
        ),
      )
      .toList(),
...
_$ChatCompletionStreamResponseDeltaAudioFromJson(Map<String, dynamic> json) =>
    _ChatCompletionStreamResponseDeltaAudio(
      id: json['id'] as String?,
...
_$ChatCompletionStreamMessageFunctionCallFromJson(Map<String, dynamic> json) =>
    _ChatCompletionStreamMessageFunctionCall(
      name: json['name'] as String?,
      arguments: json['arguments'] as String?,
    );
...
_$ChatCompletionStreamMessageToolCallChunkFromJson(Map<String, dynamic> json) =>
    _ChatCompletionStreamMessageToolCallChunk(
      index: (json['index'] as num?)?.toInt(),
      id: json['id'] as String?,
...
Map<String, dynamic> _$ChatCompletionStreamMessageToolCallChunkToJson(
  ...
  'index': ?instance.index,
  'id': ?instance.id,
  'type': ?_$ChatCompletionStreamMessageToolCallChunkTypeEnumMap[instance.type],
  'function': ?instance.function?.toJson(),
};
...
_ChatCompletionList _$ChatCompletionListFromJson(Map<String, dynamic> json) =>
    _ChatCompletionList(
      ...
      data: (json['data'] as List<dynamic>)
          .map(
            (e) => CreateChatCompletionResponse.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
...
_CreateEmbeddingResponse _$CreateEmbeddingResponseFromJson(
  ...
  data: (json['data'] as List<dynamic>)
      ...
      .toList(),
  model: json['model'] as String,
  object: $enumDecode(_$CreateEmbeddingResponseObjectEnumMap, json['object']),
  usage: json['usage'] == null
      ? null
...
const _$EmbeddingObjectEnumMap = {EmbeddingObject.embedding: 'embedding'};
...
_ListFineTuningJobEventsResponse _$ListFineTuningJobEventsResponseFromJson(
  ...
  data: (json['data'] as List<dynamic>)
      ...
      .toList(),
  object: $enumDecode(
    _$ListFineTuningJobEventsResponseObjectEnumMap,
    json['object'],
  ),
);
...
Map<String, dynamic> _$ListFineTuningJobEventsResponseToJson(
  ...
  'data': instance.data.map((e) => e.toJson()).toList(),
  'object': _$ListFineTuningJobEventsResponseObjectEnumMap[instance.object]!,
};
...
_$ListFineTuningJobCheckpointsResponseFromJson(Map<String, dynamic> json) =>
    _ListFineTuningJobCheckpointsResponse(
      data: (json['data'] as List<dynamic>)
          .map(
            (e) => FineTuningJobCheckpoint.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      object: $enumDecode(
...
_FineTuningJobCheckpoint _$FineTuningJobCheckpointFromJson(
  ...
  object: $enumDecode(_$FineTuningJobCheckpointObjectEnumMap, json['object']),
);
...
_FineTuningJobCheckpointMetrics _$FineTuningJobCheckpointMetricsFromJson(
  ...
  fullValidMeanTokenAccuracy: (json['full_valid_mean_token_accuracy'] as num?)
      ?.toDouble(),
);
...
Map<String, dynamic> _$FineTuningJobCheckpointMetricsToJson(
  ...
  'train_mean_token_accuracy': ?instance.trainMeanTokenAccuracy,
...
_CreateImageRequest _$CreateImageRequestFromJson(Map<String, dynamic> json) =>
    _CreateImageRequest(
      ...
      moderation: $enumDecodeNullable(
        _$ImageModerationEnumMap,
        json['moderation'],
        unknownValue: JsonKey.nullForUndefinedEnumValue,
      ),
      background: $enumDecodeNullable(
        _$ImageBackgroundEnumMap,
        json['background'],
        unknownValue: JsonKey.nullForUndefinedEnumValue,
      ),
...
Map<String, dynamic> _$CreateImageRequestToJson(
  _CreateImageRequest instance,
) => <String, dynamic>{
  'prompt': instance.prompt,
  'model': ?const _CreateImageRequestModelConverter().toJson(instance.model),
  'n': ?instance.n,
  'quality': ?_$ImageQualityEnumMap[instance.quality],
  'response_format': ?_$ImageResponseFormatEnumMap[instance.responseFormat],
  'output_format': ?_$ImageOutputFormatEnumMap[instance.outputFormat],
  'output_compression': ?instance.outputCompression,
...
const _$ModelObjectEnumMap = {ModelObject.model: 'model'};

_ListModelsResponse _$ListModelsResponseFromJson(Map<String, dynamic> json) =>
    _ListModelsResponse(
      object: $enumDecodeNullable(
        _$ListModelsResponseObjectEnumMap,
        json['object'],
        unknownValue: JsonKey.nullForUndefinedEnumValue,
      ),
      data: (json['data'] as List<dynamic>)
...
_$ModerationInputListModerationInputObjectFromJson(Map<String, dynamic> json) =>
    ModerationInputListModerationInputObject(
      (json['value'] as List<dynamic>)
          .map((e) => ModerationInputObject.fromJson(e as Map<String, dynamic>))
          .toList(),
      $type: json['runtimeType'] as String?,
    );
...
Map<String, dynamic> _$ModerationToJson(
  _Moderation instance,
) => <String, dynamic>{
  'flagged': instance.flagged,
  'categories': instance.categories.toJson(),
  'category_scores': instance.categoryScores.toJson(),
  'category_applied_input_types': instance.categoryAppliedInputTypes.toJson(),
};
...
_$ModerationCategoriesAppliedInputTypesFromJson(
  ...
  hate: (json['hate'] as List<dynamic>).map((e) => e as String).toList(),
  ...
  harassmentThreatening: (json['harassment/threatening'] as List<dynamic>)
      .map((e) => e as String)
      .toList(),
  illicit: (json['illicit'] as List<dynamic>).map((e) => e as String).toList(),
  ...
  selfHarmInstructions: (json['self-harm/instructions'] as List<dynamic>)
      .map((e) => e as String)
      .toList(),
  sexual: (json['sexual'] as List<dynamic>).map((e) => e as String).toList(),
...
_AssistantObject _$AssistantObjectFromJson(Map<String, dynamic> json) =>
    _AssistantObject(
      ...
      responseFormat: const _AssistantObjectResponseFormatConverter().fromJson(
        json['response_format'],
      ),
    );
...
Map<String, dynamic> _$AssistantObjectToJson(_AssistantObject instance) =>
    <String, dynamic>{
      ...
      'temperature': ?instance.temperature,
      'top_p': ?instance.topP,
      'response_format': ?const _AssistantObjectResponseFormatConverter()
...
_$AssistantObjectResponseFormatEnumerationFromJson(Map<String, dynamic> json) =>
    AssistantObjectResponseFormatEnumeration(
...
_CreateAssistantRequest _$CreateAssistantRequestFromJson(
  ...
  toolResources: json['tool_resources'] == null
      ? null
      : ToolResources.fromJson(json['tool_resources'] as Map<String, dynamic>),
  metadata: json['metadata'] as Map<String, dynamic>?,
  temperature: (json['temperature'] as num?)?.toDouble() ?? 1.0,
  topP: (json['top_p'] as num?)?.toDouble() ?? 1.0,
...
Map<String, dynamic> _$CreateAssistantRequestToJson(
  ...
  'temperature': ?instance.temperature,
  'top_p': ?instance.topP,
  'response_format': ?const _CreateAssistantRequestResponseFormatConverter()
      .toJson(instance.responseFormat),
};
...
_$CreateAssistantRequestResponseFormatEnumerationFromJson(
  ...
  $enumDecode(_$CreateAssistantResponseFormatModeEnumMap, json['value']),
  $type: json['runtimeType'] as String?,
);
...
Map<String, dynamic> _$ModifyAssistantRequestToJson(
  ...
  'temperature': ?instance.temperature,
  'top_p': ?instance.topP,
  'response_format': ?const _ModifyAssistantRequestResponseFormatConverter()
      .toJson(instance.responseFormat),
};
...
_$ModifyAssistantRequestResponseFormatEnumerationFromJson(
  ...
  $enumDecode(_$ModifyAssistantResponseFormatModeEnumMap, json['value']),
  $type: json['runtimeType'] as String?,
);
...
_DeleteAssistantResponse _$DeleteAssistantResponseFromJson(
  ...
  id: json['id'] as String,
  deleted: json['deleted'] as bool,
  object: $enumDecode(_$DeleteAssistantResponseObjectEnumMap, json['object']),
);
...
_FileSearchRankingOptions _$FileSearchRankingOptionsFromJson(
  ...
  ranker: $enumDecodeNullable(
    _$FileSearchRankerEnumMap,
    json['ranker'],
    unknownValue: JsonKey.nullForUndefinedEnumValue,
  ),
...
_AssistantsFunctionCallOption _$AssistantsFunctionCallOptionFromJson(
  Map<String, dynamic> json,
) => _AssistantsFunctionCallOption(name: json['name'] as String);
...
_RunObject _$RunObjectFromJson(Map<String, dynamic> json) => _RunObject(
  ...
  toolChoice: const _RunObjectToolChoiceConverter().fromJson(
    json['tool_choice'],
  ),
  parallelToolCalls: json['parallel_tool_calls'] as bool?,
  responseFormat: const _RunObjectResponseFormatConverter().fromJson(
    json['response_format'],
  ),
);
...
Map<String, dynamic> _$RunObjectToJson(_RunObject instance) =>
    <String, dynamic>{
      ...
      'tool_choice': _$JsonConverterToJson<Object?, RunObjectToolChoice>(
        instance.toolChoice,
        const _RunObjectToolChoiceConverter().toJson,
      ),
      'parallel_tool_calls': instance.parallelToolCalls,
      'response_format': const _RunObjectResponseFormatConverter().toJson(
        instance.responseFormat,
      ),
    };

const _$RunObjectObjectEnumMap = {RunObjectObject.threadRun: 'thread.run'};
...
_RunObjectIncompleteDetails _$RunObjectIncompleteDetailsFromJson(
  ...
  reason: $enumDecodeNullable(
    _$RunObjectIncompleteDetailsReasonEnumMap,
    json['reason'],
    unknownValue: JsonKey.nullForUndefinedEnumValue,
  ),
);
...
_$RunObjectToolChoiceAssistantsNamedToolChoiceFromJson(
  ...
  AssistantsNamedToolChoice.fromJson(json['value'] as Map<String, dynamic>),
  $type: json['runtimeType'] as String?,
);
...
_$RunObjectResponseFormatResponseFormatFromJson(Map<String, dynamic> json) =>
    RunObjectResponseFormatResponseFormat(
      ResponseFormat.fromJson(json['value'] as Map<String, dynamic>),
      $type: json['runtimeType'] as String?,
    );
...
_CreateRunRequest _$CreateRunRequestFromJson(Map<String, dynamic> json) =>
    _CreateRunRequest(
      ...
      toolChoice: const _CreateRunRequestToolChoiceConverter().fromJson(
        json['tool_choice'],
      ),
      parallelToolCalls: json['parallel_tool_calls'] as bool?,
      responseFormat: const _CreateRunRequestResponseFormatConverter().fromJson(
        json['response_format'],
      ),
...
Map<String, dynamic> _$CreateRunRequestToJson(_CreateRunRequest instance) =>
    <String, dynamic>{
      ...
      'additional_messages': ?instance.additionalMessages
          ?.map((e) => e.toJson())
          .toList(),
      'tools': ?instance.tools?.map((e) => e.toJson()).toList(),
      'metadata': ?instance.metadata,
      ...
      'max_completion_tokens': ?instance.maxCompletionTokens,
      'truncation_strategy': ?instance.truncationStrategy?.toJson(),
      'tool_choice': ?const _CreateRunRequestToolChoiceConverter().toJson(
        instance.toolChoice,
      ),
      'parallel_tool_calls': ?instance.parallelToolCalls,
      'response_format': ?const _CreateRunRequestResponseFormatConverter()
          .toJson(instance.responseFormat),
      'stream': ?instance.stream,
    };
...
_$CreateRunRequestToolChoiceEnumerationFromJson(Map<String, dynamic> json) =>
    CreateRunRequestToolChoiceEnumeration(
...
_$CreateRunRequestResponseFormatEnumerationFromJson(
  ...
  $enumDecode(_$CreateRunRequestResponseFormatModeEnumMap, json['value']),
  $type: json['runtimeType'] as String?,
);
...
_ModifyRunRequest _$ModifyRunRequestFromJson(Map<String, dynamic> json) =>
    _ModifyRunRequest(metadata: json['metadata'] as Map<String, dynamic>?);
...
_CreateThreadAndRunRequest _$CreateThreadAndRunRequestFromJson(
  ...
  toolChoice: const _CreateThreadAndRunRequestToolChoiceConverter().fromJson(
    json['tool_choice'],
  ),
  parallelToolCalls: json['parallel_tool_calls'] as bool?,
...
Map<String, dynamic> _$CreateThreadAndRunRequestToJson(
  ...
  'max_completion_tokens': ?instance.maxCompletionTokens,
  'truncation_strategy': ?instance.truncationStrategy?.toJson(),
  'tool_choice': ?const _CreateThreadAndRunRequestToolChoiceConverter().toJson(
    instance.toolChoice,
  ),
  'parallel_tool_calls': ?instance.parallelToolCalls,
  'response_format': ?const _CreateThreadAndRunRequestResponseFormatConverter()
      .toJson(instance.responseFormat),
  'stream': ?instance.stream,
};
...
_$CreateThreadAndRunRequestToolChoiceEnumerationFromJson(
  ...
  $enumDecode(_$CreateThreadAndRunRequestToolChoiceModeEnumMap, json['value']),
  $type: json['runtimeType'] as String?,
);
...
Map<String, dynamic> _$CreateThreadAndRunRequestToolChoiceEnumerationToJson(
  ...
  'value': _$CreateThreadAndRunRequestToolChoiceModeEnumMap[instance.value]!,
  'runtimeType': instance.$type,
};
...
_$CreateThreadAndRunRequestToolChoiceAssistantsNamedToolChoiceToJson(
  CreateThreadAndRunRequestToolChoiceAssistantsNamedToolChoice instance,
) => <String, dynamic>{
  'value': instance.value.toJson(),
  'runtimeType': instance.$type,
};
...
_$CreateThreadAndRunRequestResponseFormatEnumerationFromJson(
  ...
  $enumDecode(
    _$CreateThreadAndRunRequestResponseFormatModeEnumMap,
    json['value'],
  ),
  $type: json['runtimeType'] as String?,
);
...
const _$ThreadObjectObjectEnumMap = {ThreadObjectObject.thread: 'thread'};
...
) => <String, dynamic>{'file_ids': instance.fileIds};
...
_ToolResourcesFileSearch _$ToolResourcesFileSearchFromJson(
  ...
  vectorStores: (json['vector_stores'] as List<dynamic>?)
      ?.map(
        (e) => ToolResourcesFileSearchVectorStore.fromJson(
          e as Map<String, dynamic>,
        ),
      )
      .toList(),
...
Map<String, dynamic> _$ToolResourcesFileSearchToJson(
  ...
  'vector_store_ids': ?instance.vectorStoreIds,
...
Map<String, dynamic> _$ToolResourcesFileSearchVectorStoreToJson(
  ...
  'file_ids': ?instance.fileIds,
  'chunking_strategy': ?instance.chunkingStrategy?.toJson(),
  'metadata': ?instance.metadata,
};
...
_MessageObjectIncompleteDetails _$MessageObjectIncompleteDetailsFromJson(
  ...
  reason: $enumDecode(
    _$MessageObjectIncompleteDetailsReasonEnumMap,
    json['reason'],
  ),
);
...
_CreateMessageRequest _$CreateMessageRequestFromJson(
  ...
  role: $enumDecode(_$MessageRoleEnumMap, json['role']),
  content: const _CreateMessageRequestContentConverter().fromJson(
    json['content'],
  ),
  attachments: (json['attachments'] as List<dynamic>?)
      ?.map((e) => MessageAttachment.fromJson(e as Map<String, dynamic>))
...
Map<String, dynamic> _$CreateMessageRequestToJson(
  ...
  'role': _$MessageRoleEnumMap[instance.role]!,
  'content': const _CreateMessageRequestContentConverter().toJson(
    instance.content,
  ),
  'attachments': ?instance.attachments?.map((e) => e.toJson()).toList(),
  'metadata': ?instance.metadata,
...
_ModifyMessageRequest _$ModifyMessageRequestFromJson(
  Map<String, dynamic> json,
) => _ModifyMessageRequest(metadata: json['metadata'] as Map<String, dynamic>?);
...
_MessageContentImageFile _$MessageContentImageFileFromJson(
  ...
  fileId: json['file_id'] as String,
  detail:
      $enumDecodeNullable(_$MessageContentImageDetailEnumMap, json['detail']) ??
...
_MessageContentText _$MessageContentTextFromJson(Map<String, dynamic> json) =>
    _MessageContentText(
      ...
      annotations: (json['annotations'] as List<dynamic>?)
          ?.map(
            (e) => MessageContentTextAnnotations.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
...
_MessageDeltaContentText _$MessageDeltaContentTextFromJson(
  ...
  annotations: (json['annotations'] as List<dynamic>?)
      ?.map(
        (e) => MessageDeltaContentTextAnnotations.fromJson(
          e as Map<String, dynamic>,
        ),
      )
      .toList(),
...
) => <String, dynamic>{'file_id': ?instance.fileId, 'quote': ?instance.quote};

_RunStepObject _$RunStepObjectFromJson(
  Map<String, dynamic> json,
) => _RunStepObject(
  id: json['id'] as String,
  ...
  stepDetails: RunStepDetails.fromJson(
    json['step_details'] as Map<String, dynamic>,
  ),
  lastError: json['last_error'] == null
      ? null
      : RunStepLastError.fromJson(json['last_error'] as Map<String, dynamic>),
  ...
  usage: json['usage'] == null
      ? null
      : RunStepCompletionUsage.fromJson(json['usage'] as Map<String, dynamic>),
);
...
Map<String, dynamic> _$RunStepDeltaToJson(_RunStepDelta instance) =>
    <String, dynamic>{'step_details': ?instance.stepDetails?.toJson()};
...
_RunStepDetailsMessageCreation _$RunStepDetailsMessageCreationFromJson(
  Map<String, dynamic> json,
) => _RunStepDetailsMessageCreation(messageId: json['message_id'] as String);
...
_$RunStepDeltaStepDetailsMessageCreationFromJson(Map<String, dynamic> json) =>
    _RunStepDeltaStepDetailsMessageCreation(
...
_$RunStepDetailsToolCallsCodeObjectCodeInterpreterFromJson(
  ...
  outputs: (json['outputs'] as List<dynamic>)
      .map(
        (e) => RunStepDetailsToolCallsCodeOutput.fromJson(
          e as Map<String, dynamic>,
        ),
      )
      .toList(),
...
_$RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterFromJson(
  ...
  outputs: (json['outputs'] as List<dynamic>?)
      ?.map(
        (e) => RunStepDeltaStepDetailsToolCallsCodeOutput.fromJson(
          e as Map<String, dynamic>,
        ),
      )
      .toList(),
...
Map<String, dynamic>
_$RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterToJson(
...
_$RunStepDetailsToolCallsCodeOutputImageFromJson(Map<String, dynamic> json) =>
    _RunStepDetailsToolCallsCodeOutputImage(fileId: json['file_id'] as String);
...
Map<String, dynamic> _$RunStepDetailsToolCallsFileSearchToJson(
  ...
  'ranking_options': ?instance.rankingOptions?.toJson(),
  'results': ?instance.results?.map((e) => e.toJson()).toList(),
};
...
_$RunStepDetailsToolCallsFileSearchResultObjectFromJson(
  ...
  content: (json['content'] as List<dynamic>?)
      ?.map(
        (e) => RunStepDetailsToolCallsFileSearchResultContent.fromJson(
          e as Map<String, dynamic>,
        ),
      )
      .toList(),
...
_VectorStoreExpirationAfter _$VectorStoreExpirationAfterFromJson(
  ...
  anchor: $enumDecode(
    _$VectorStoreExpirationAfterAnchorEnumMap,
    json['anchor'],
  ),
...
Map<String, dynamic> _$VectorStoreObjectToJson(_VectorStoreObject instance) =>
    <String, dynamic>{
      ...
      'expires_after': ?instance.expiresAfter?.toJson(),
      'expires_at': ?instance.expiresAt,
...
_VectorStoreFileObjectLastError _$VectorStoreFileObjectLastErrorFromJson(
  ...
  code: $enumDecode(_$VectorStoreFileObjectLastErrorCodeEnumMap, json['code']),
  message: json['message'] as String,
);
...
_VectorStoreFileBatchObject _$VectorStoreFileBatchObjectFromJson(
  ...
  vectorStoreId: json['vector_store_id'] as String,
  status: $enumDecode(
    _$VectorStoreFileBatchObjectStatusEnumMap,
    json['status'],
  ),
...
_CreateBatchRequest _$CreateBatchRequestFromJson(Map<String, dynamic> json) =>
    _CreateBatchRequest(
      ...
      completionWindow: $enumDecode(
        _$BatchCompletionWindowEnumMap,
        json['completion_window'],
      ),
      metadata: (json['metadata'] as Map<String, dynamic>?)?.map(
        (k, e) => MapEntry(k, e as String),
      ),
...
const _$BatchCompletionWindowEnumMap = {BatchCompletionWindow.v24h: '24h'};
...
Map<String, dynamic> _$BatchToJson(_Batch instance) => <String, dynamic>{
  ...
  'output_file_id': ?instance.outputFileId,
  'error_file_id': ?instance.errorFileId,
  'created_at': instance.createdAt,
  'in_progress_at': ?instance.inProgressAt,
  'expires_at': ?instance.expiresAt,
  'finalizing_at': ?instance.finalizingAt,
  'completed_at': ?instance.completedAt,
  'failed_at': ?instance.failedAt,
  'expired_at': ?instance.expiredAt,
  'cancelling_at': ?instance.cancellingAt,
  'cancelled_at': ?instance.cancelledAt,
...
_WebSearchOptionsUserLocation _$WebSearchOptionsUserLocationFromJson(
  ...
  type: $enumDecode(_$WebSearchOptionsUserLocationTypeEnumMap, json['type']),
...
ChatCompletionDeveloperMessage _$ChatCompletionDeveloperMessageFromJson(
  ...
  role:
      $enumDecodeNullable(_$ChatCompletionMessageRoleEnumMap, json['role']) ??
      ChatCompletionMessageRole.developer,
  content: const _ChatCompletionDeveloperMessageContentConverter().fromJson(
    json['content'],
  ),
  name: json['name'] as String?,
);
...
Map<String, dynamic> _$ChatCompletionDeveloperMessageToJson(
  ...
  'role': _$ChatCompletionMessageRoleEnumMap[instance.role]!,
  'content': const _ChatCompletionDeveloperMessageContentConverter().toJson(
    instance.content,
  ),
  'name': ?instance.name,
};
...
ChatCompletionUserMessage _$ChatCompletionUserMessageFromJson(
  ...
  content: const _ChatCompletionUserMessageContentConverter().fromJson(
    json['content'],
  ),
  name: json['name'] as String?,
);
...
Map<String, dynamic> _$ChatCompletionUserMessageToJson(
  ...
  'role': _$ChatCompletionMessageRoleEnumMap[instance.role]!,
  'content': const _ChatCompletionUserMessageContentConverter().toJson(
    instance.content,
  ),
  'name': ?instance.name,
};
...
_$ChatCompletionDeveloperMessageContentPartsFromJson(
  ...
  (json['value'] as List<dynamic>)
      .map(
        (e) => ChatCompletionMessageContentPart.fromJson(
          e as Map<String, dynamic>,
        ),
      )
      .toList(),
...
_$ChatCompletionUserMessageContentStringFromJson(Map<String, dynamic> json) =>
    ChatCompletionUserMessageContentString(
      json['value'] as String,
      $type: json['runtimeType'] as String?,
    );
...
_$ChatCompletionMessageContentPartImageFromJson(Map<String, dynamic> json) =>
    ChatCompletionMessageContentPartImage(
      type:
          $enumDecodeNullable(
            _$ChatCompletionMessageContentPartTypeEnumMap,
...
_$ChatCompletionMessageContentPartAudioFromJson(Map<String, dynamic> json) =>
    ChatCompletionMessageContentPartAudio(
      type:
          $enumDecodeNullable(
            _$ChatCompletionMessageContentPartTypeEnumMap,
...
_$ChatCompletionMessageContentPartRefusalFromJson(Map<String, dynamic> json) =>
    ChatCompletionMessageContentPartRefusal(
      type:
          $enumDecodeNullable(
            _$ChatCompletionMessageContentPartTypeEnumMap,
...
_ChatCompletionMessageImageUrl _$ChatCompletionMessageImageUrlFromJson(
  ...
  detail:
      $enumDecodeNullable(
        _$ChatCompletionMessageImageDetailEnumMap,
        json['detail'],
      ) ??
...
_ChatCompletionMessageInputAudio _$ChatCompletionMessageInputAudioFromJson(
  ...
  data: json['data'] as String,
  format: $enumDecode(
    _$ChatCompletionMessageInputAudioFormatEnumMap,
    json['format'],
  ),
);
...
Map<String, dynamic> _$ChatCompletionMessageInputAudioToJson(
  ...
  'data': instance.data,
  'format': _$ChatCompletionMessageInputAudioFormatEnumMap[instance.format]!,
};
...
ResponseFormatText _$ResponseFormatTextFromJson(Map<String, dynamic> json) =>
    ResponseFormatText(
      type:
          $enumDecodeNullable(_$ResponseFormatTypeEnumMap, json['type']) ??
          ResponseFormatType.text,
    );

Map<String, dynamic> _$ResponseFormatTextToJson(ResponseFormatText instance) =>
    <String, dynamic>{'type': _$ResponseFormatTypeEnumMap[instance.type]!};
...
ModerationInputObjectImageUrl _$ModerationInputObjectImageUrlFromJson(
  ...
  type:
      $enumDecodeNullable(_$ModerationInputObjectTypeEnumMap, json['type']) ??
...
_$ModerationInputObjectImageUrlImageUrlFromJson(Map<String, dynamic> json) =>
    _ModerationInputObjectImageUrlImageUrl(url: json['url'] as String);
...
Map<String, dynamic> _$AssistantToolsFileSearchFileSearchToJson(
  ...
  'max_num_results': ?instance.maxNumResults,
  'ranking_options': ?instance.rankingOptions?.toJson(),
};
...
) => <String, dynamic>{'type': instance.type, 'text': instance.text.toJson()};
...
) => <String, dynamic>{'type': instance.type, 'refusal': instance.refusal};
...
MessageDeltaContentTextObject _$MessageDeltaContentTextObjectFromJson(
  ...
  text: json['text'] == null
      ? null
      : MessageDeltaContentText.fromJson(json['text'] as Map<String, dynamic>),
);
...
_$MessageContentTextAnnotationsFilePathFromJson(Map<String, dynamic> json) =>
    _MessageContentTextAnnotationsFilePath(fileId: json['file_id'] as String);
...
_$MessageDeltaContentTextAnnotationsFilePathObjectFromJson(
  ...
  filePath: json['file_path'] == null
      ? null
      : MessageDeltaContentTextAnnotationsFilePathObjectFilePath.fromJson(
          json['file_path'] as Map<String, dynamic>,
        ),
  startIndex: (json['start_index'] as num?)?.toInt(),
  endIndex: (json['end_index'] as num?)?.toInt(),
...
Map<String, dynamic>
_$MessageDeltaContentTextAnnotationsFilePathObjectFilePathToJson(
...
RunStepDetailsToolCallsObject _$RunStepDetailsToolCallsObjectFromJson(
  ...
  type: json['type'] as String,
  toolCalls: (json['tool_calls'] as List<dynamic>)
      .map((e) => RunStepDetailsToolCalls.fromJson(e as Map<String, dynamic>))
      .toList(),
);
...
_$RunStepDeltaStepDetailsToolCallsObjectFromJson(Map<String, dynamic> json) =>
    RunStepDeltaStepDetailsToolCallsObject(
      type: json['type'] as String,
      toolCalls: (json['tool_calls'] as List<dynamic>?)
          ?.map(
            (e) => RunStepDeltaStepDetailsToolCalls.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
...
RunStepDetailsToolCallsCodeObject _$RunStepDetailsToolCallsCodeObjectFromJson(
  ...
  id: json['id'] as String,
  type: json['type'] as String,
  codeInterpreter: RunStepDetailsToolCallsCodeObjectCodeInterpreter.fromJson(
    json['code_interpreter'] as Map<String, dynamic>,
  ),
);
...
_$RunStepDetailsToolCallsFileSearchObjectFromJson(Map<String, dynamic> json) =>
    RunStepDetailsToolCallsFileSearchObject(
      id: json['id'] as String,
      type: json['type'] as String,
...
_$RunStepDetailsToolCallsFunctionObjectFromJson(Map<String, dynamic> json) =>
    RunStepDetailsToolCallsFunctionObject(
      id: json['id'] as String,
      type: json['type'] as String,
...
_$RunStepDeltaStepDetailsToolCallsFunctionFromJson(Map<String, dynamic> json) =>
    _RunStepDeltaStepDetailsToolCallsFunction(
      name: json['name'] as String?,
      arguments: json['arguments'] as String?,
      output: json['output'] as String?,
...
) => <String, dynamic>{'type': instance.type, 'logs': instance.logs};
...
) => <String, dynamic>{'type': instance.type, 'image': instance.image.toJson()};
...
AutoChunkingStrategyRequestParam _$AutoChunkingStrategyRequestParamFromJson(
  Map<String, dynamic> json,
) => AutoChunkingStrategyRequestParam(type: json['type'] as String);
...
OtherChunkingStrategyResponseParam _$OtherChunkingStrategyResponseParamFromJson(
  Map<String, dynamic> json,
) => OtherChunkingStrategyResponseParam(type: json['type'] as String);
